...
elevator_floor, elevator_pos = exit_floor,exit_pos #Initialisation avec l'exit - Cas où il n'y a qu'un étage avec une sortie
dict_floor_pos = {exit_floor:exit_pos}  #Dictionnaire de couple étage/sortie, Ajout du couple pour l'ascenseur exit

for i in range(nb_elevators): #Remplissage de la liste couple étage/sortie
...
while True:
    ...
    direction = inputs[2]  # Direction du clone learder: LEFT or RIGHT
...
nb_floors, width, nb_rounds, exit_floor, exit_pos, nb_total_clones, nb_additional_elevators, nb_elevators = [int(i) for i in input().split()]
elevator_floor, elevator_pos = exit_floor,exit_pos #Initialisation avec l'exit - Cas où il n'y a qu'un étage avec une sortie
L_elevator_floor_and_pos = [[exit_floor,exit_pos]] #Liste de couple étage/sortie, Ajout du couple pour l'ascenseur exit
...
while True:
    ...
    for couple in L_elevator_floor_and_pos: #trouver la position de l'ascenseur
